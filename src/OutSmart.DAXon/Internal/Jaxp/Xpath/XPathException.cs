...
namespace OutSmart.DAXon.Internal.Jaxp.Xpath
{
    using global::OutSmart.DAXon.Internal.Jaxp.Namespace;
    public class XPathException : Exception { public XPathException(string m) : base(m) { } }
}
